...
export function validateIdDetail(repository: Repository<any>, bodyName: string, columnNameId: string, errorMessage: string)
{
    return async (req: Request, res: Response, next: NextFunction) =>
    {
        try 
        {
            ...
            if(Array.isArray(body))
            {
                ...
                {
                    const itemId = parseInt(column[columnNameId]);
